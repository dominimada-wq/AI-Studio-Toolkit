...
Commit fonctionnel `5252066083d66ef51f6816df46ee469b26361fff` (« Guard ComfyUI teardown against stale terminate timers », 3 fichiers : `src/ui/comfyui_lifecycle_manager.py`, `tests/integration/test_comfyui_lifecycle_manager.py`, `docs/missions/MISSION_142.md`), poussé sur `main` (`718b530..5252066`). Tag annoté `v0.2-mission142` créé exactement sur ce commit (objet tag local et distant `82d44eb1edfb79e60a652c8a44093dca15122662`, peeled target local et distant tous deux `5252066083d66ef51f6816df46ee469b26361fff`, vérifiés identiques), poussé et confirmé sur `origin`. GitHub Release `v0.2-mission142` publiée manuellement (titre « v0.2-mission142 — Guard ComfyUI Teardown Against Stale Terminate Timers »).
