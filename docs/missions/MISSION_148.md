...
Commit fonctionnel `dffe92c09dbcd55e5c950d8c065708682034e0fe` (« Preserve successful training output after late cancel », 3 fichiers : `src/ui/training_job_runner.py`, `tests/integration/test_training_job_runner.py`, `docs/missions/MISSION_148.md`), poussé sur `main` (`4d970a4..dffe92c`). Tag annoté `v0.2-mission148` créé exactement sur ce commit (objet tag local et distant `b8290a0936d2a074934447ac0981165620693736`, peeled target local et distant tous deux `dffe92c09dbcd55e5c950d8c065708682034e0fe`, vérifiés identiques), poussé et confirmé sur `origin`. `v0.2-mission147` (peeled `3f9d9e7a8e02b05a72f24bfae2e233e4b62ca06a`), `v0.2-mission146` (peeled `24613861960e3f4e6c87c9a80c8f111f00f74b7a`) et `v0.2-mission145` (peeled `3dcc625f02bca4e9398c1db8c933550058513582`) reconfirmés inchangés. GitHub Release `v0.2-mission148` publiée manuellement (titre « v0.2-mission148 — Preserve Successful Training Output After Late Cancel »).
